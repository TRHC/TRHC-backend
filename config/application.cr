...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Bhota Bot web application."
  #
  #
  ...
  #
  # settings.secret_key_base= DYqWN6l3O-PKgEzCLKQhdcCgVNOcJRkpYqtQVLCKMsY
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("bhota_bot.log", "w"))
  #
  #
end
